...
public class FishEditPriceBtn extends AdminFishMenuButton {

    public FishEditPriceBtn(FishType fishType) {
        super(fishType);
    }
    ...
    public ItemStack buildItemStack(Player player) {
        ...
        m.setDisplayName("Base Price");
        ArrayList<String> lore = new ArrayList<>();
        lore.add(String.valueOf(fishType.PriceBase));
        m.setLore(lore);
    ...
    protected void click_left() {
        ...
        getConversation(player, new PricePrompt()).begin();
    }
    ...
    private class PricePrompt extends NumericPrompt {
        ...
        public String getPromptText(@NotNull ConversationContext context) {
            ...
            return Formatting.GetMessagePrefix() + "What should the baseline price of a " + type.Name + " be? Current: " + type.PriceBase;
        }
        ...
        protected Prompt acceptValidatedInput(@NotNull ConversationContext conversationContext, @NotNull Number number) {
            ...
            type.PriceBase = number.doubleValue();
