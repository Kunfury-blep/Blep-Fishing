...
public class FishType {
    ...
    public FishObject GenerateFish(Rarity rarity, UUID playerId, Integer rodId, boolean allBlue, List<FishingArea> fishingAreas){
        ...
        return new FishObject(rarity.Id, Id, length, playerId, rodId, fishingAreas);
    }
...
//        }
    ...
    public void Spawn(Player player){
        FishObject fish = GenerateFish(Rarity.GetRandom(), null, null, false, null);
