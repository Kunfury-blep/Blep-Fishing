...
public class TournamentBossbarTimerPercentButton extends AdminConfigButtonBase {
    @Override
    public String getId() {
        return "adminTournamentConfigBossbarTimerPercentButton";
    }
    ...
    public ItemStack getItemStack(Object o) {
        ...
        assert m != null;
        m.setDisplayName("Bossbar Timer Perecent");

        lore.add(String.valueOf(t.BossbarTimePercent));
    ...
    private class PercentPrompt extends ValidatingPrompt{
        ...
        public String getPromptText(@NotNull ConversationContext context) {
            return "What Completion Percent should the bossbar show? Current: " + getTournament().BossbarTimePercent; //TODO: Seems to sometimes have trailing values
        }
        ...
        protected Prompt acceptValidatedInput(@NotNull ConversationContext conversationContext, @NotNull String value) {
            ...
            TournamentHandler.UpdateTournamentValue(t.getName() + ".Bossbar Timer Percent", percent);
            t.BossbarTimePercent = percent;
