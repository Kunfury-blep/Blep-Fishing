...
public class TournamentMaxAmountButton extends AdminConfigButtonBase {
    @Override
    public String getId() {
        return "adminTournamentConfigMaxFishButton";
    }
    ...
    private class AmountPrompt extends NumericPrompt{
        ...
        public String getPromptText(@NotNull ConversationContext context) {
            return "How many fish can be caught before the tournament ends? Set to 0 for infinite. \nCurrent: " + getTournament().MaxFish;
        }
