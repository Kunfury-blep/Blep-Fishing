...
public class TournamentDurationButton extends AdminConfigButtonBase {
    @Override
    public String getId() {
        return "adminTournamentConfigDurationButton";
    }
    ...
    public ItemStack getItemStack(Object o) {
        ...
        lore.add(Formatting.asTime((long) (t.getDuration() * 60 * 60 * 1000)));
    ...
    private class DurationPrompt extends NumericPrompt{
        ...
        public String getPromptText(@NotNull ConversationContext context) {
            return "How many hours should the tournament last? Current: " + getTournament().getDuration(); //TODO: Seems to sometimes have trailing values
        }

        @Nullable
        @Override
        protected Prompt acceptValidatedInput(@NotNull ConversationContext context, @NotNull Number duration) {
            TournamentObject t =  getTournament();

            TournamentHandler.UpdateTournamentValue(t.getName() + ".Duration", duration);
            t.setDuration(duration.doubleValue());
