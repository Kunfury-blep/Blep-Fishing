...
public class WorldGuardHandler {
    ...
    public static List<BaseFishObject> GetFish(Location loc){
        var regions = getRegions(loc);

        List<BaseFishObject> baseFishList = new ArrayList<>();
            ...
            for (var region : regions) {
                ...
                flags.forEach((key, value) -> {
                    if(key.getName().equals("bf-fish")){
                        BaseFishObject bFish = BaseFishObject.getBase((String)value);
                        if(bFish != null){
                            baseFishList.add(bFish);
                        }
    ...
    public static List<AreaObject> GetAreas(Location loc){
        ...
        List<AreaObject> areaList = new ArrayList<>();
            ...
            for (var region : regions) {
                ...
                flags.forEach((key, value) -> {
                    if(key.getName().equals("bf-area")){
                        AreaObject area = AreaObject.FromString((String)value);
                        if(area != null){
                            areaList.add(area);
                        }
